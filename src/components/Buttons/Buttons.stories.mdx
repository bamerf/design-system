...
<Preview withToolbar>
	<Story name="primary">
		<Button disabled={boolean("Disabled", false)}>Primary</Button>
	</Story>
</Preview>
...
<Preview withToolbar>
	<Story name="secondary">
		<Button type="secondary" disabled={boolean("Disabled", false)}>Secondary</Button>
	</Story>
</Preview>
...
<Preview withToolbar>
	<Story name="tertiary">
		<Button type="tertiary" disabled={boolean("Disabled", false)}>Tertiary</Button>
	</Story>
</Preview>